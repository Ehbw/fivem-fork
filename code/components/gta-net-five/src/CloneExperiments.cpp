...
//48 89 5C 24 ? 57 48 83 EC ? 48 8B D9 33 FF 48 8B 89 ? ? ? ? 48 85 C9 74 ? 48 3B 99

static hook::cdecl_stub<void(CNetGamePlayer*)> _setPlayerActive([]()
{
	return hook::get_pattern("48 89 5C 24 ? 57 48 83 EC ? 48 8B D9 33 FF 48 8B 89 ? ? ? ? 48 85 C9 74 ? 48 3B 99");
});
...
static void* JoinPhysicalPlayerOnHost(void* bubbleMgr, void* scSessionImpl, void* playerDataMsg, void* a4, uint8_t slotIndex)
{
	...
	_setPlayerActive(rage::GetLocalPlayer());
...
static HookFunction hookFunction([]()
{
	...
	// replace joining local net player to bubble
	{
		...
		MH_CreateHook(hook::get_pattern("48 89 5C 24 ? 48 89 74 24 ? 57 48 83 EC ? 8A 44 24 ? 48 8B F1"), JoinPhysicalPlayerOnHost, (void**)&g_origJoinBubble);
#endif

...
///
/// This file is based on CefClient's osr_ime_handler_win.cc
/// https://github.com/chromiumembedded/cef/blob/master/tests/cefclient/browser/osr_window_win.cc
/// Based on commit: fdc671eae51a0079d5ebefa49e94b65f54d5e2cb
/// 
...
void OsrImeHandlerWin::GetCompositionInfo(
	...
	uint32_t length = static_cast<int>(composition_text.length());
